...
BOOL APIENTRY DllMain(HMODULE hModule, DWORD ul_reason_for_call, LPVOID lpReserved)
{
    ...
    case DLL_PROCESS_ATTACH:
        ...
        {
            const BYTE Allow_Building_Close_To_Palbox_Pattern[] = { 0x74, 0x15, 0x48, 0x8B, 0x9E, 0xA8, 0x02, 0x00, 0x00, 0xB2, 0x02, 0x0F, 0xB6, 0x4B, 0x30, 0xE8, 0xCC, 0xCC, 0xCC, 0x00, 0x88 };
